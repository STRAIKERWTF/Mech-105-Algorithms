...
L(R,C) = 1
%Fix for a stange error on some rare matrices where the bottom right value of the
%L matrix is 0 instead of 1
...
if (P*L*U) ~= A
    error('Calculation error on final error check. P*L*U ~= A')
end 
